...
export class KodiAudioLibraryNamespace {
   ...
   * @param theme null | ArrayString (optional)
   * @param mood null | ArrayString (optional)
   * @param style null | ArrayString (optional)
   ...
   * @param musicbrainzalbumartistid null | ArrayString (optional)
   ...
   * @param instrument null | ArrayString (optional)
   * @param style null | ArrayString (optional)
   * @param mood null | ArrayString (optional)
   ...
   * @param yearsactive null | ArrayString (optional)
